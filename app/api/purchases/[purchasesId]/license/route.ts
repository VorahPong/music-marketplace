...
<body>
	<main class="document">
		...
		<section class="notice">
			<strong>Important:</strong> This document is a generated marketplace license based on the purchase record. For high-value releases or exclusive rights, both parties should use a separate written agreement.
		</section>

		<div class="footer">
			Generated by Music Marketplace. This license is tied to the purchase record shown above.
		</div>
	</main>
</body>
</html>`;
